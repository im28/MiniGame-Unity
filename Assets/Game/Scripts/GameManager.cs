...
public class GameManager : MonoBehaviour
{
    ...
    private static int enemyShipCount = 5;
    private static int playerShipCount = 5;

    public static int getScore()
    {
        return (playerShipCount - enemyShipCount);
    }
    // Start is called before the first frame update
    void Start()
    {
        Debug.Log(Difficulty.selectedDifficultyType);
        topText.text = "Welcome " + LoggedInUser.alias;
    ...
    {
        if (setupComplete && playerTurn && gameNotOver)
        {
